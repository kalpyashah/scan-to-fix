...
import { Fan, Snowflake, Lightbulb, Plug, MonitorPlay, CheckCircle, Loader2, AlertCircle, X, Bell, History, PenTool, ChevronRight, MapPin } from "lucide-react"
      ...
      <div className="px-6 -mt-12 relative z-20 space-y-4 max-w-md mx-auto">
        ...
        <div className="bg-white rounded-[2rem] p-6 shadow-xl shadow-slate-200/50 border border-slate-100">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <IssueButton icon={<MonitorPlay />} label="Smartboard" isSelected={selectedIssue === "Smartboard"} onClick={() => setSelectedIssue("Smartboard")} />
